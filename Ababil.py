...
def ceknet():
    try:
        ...
        try:
            ...
            time.sleep(3.5)
            print '\033[37;1m]\033[35;1m ~>\033[31;1mThere is no connection'
            time.sleep(1.5)
            sys.exit()
